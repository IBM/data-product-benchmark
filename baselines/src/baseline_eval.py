...
def load_ground_truth(dataset_name, split):
    ...
    repo_id = "ibm-research/data-product-benchmark"
    print(f"loading HF dataset {dataset_name}-{split} from {repo_id}")
...
def main(args):
    ...
    dpr_to_gt, dpr_to_query = load_ground_truth(dataset_name, split)
